...
const translations = {
  ...
  km: {
    ...
    ui: {
      ...
      signup_button_loading: "កំពុងបង្កើតគណនី...",
      login_button: "ចូលគណនី",
      login_button_loading: "កំពុងចូលគណនី...",
      signup_error: "មិនអាចបង្កើតគណនីបានទេ សូមព្យាយាមម្តងទៀត។",
      login_error: "អ៊ីមែល ឬពាក្យសម្ងាត់មិនត្រឹមត្រូវ",
      have_account_prompt: "មានគណនីរួចហើយ?",
      no_account_prompt: "មិនទាន់មានគណនី?",
      nav_login: "ចូលគណនី",
      nav_signup: "ចុះឈ្មោះ",
      nav_logout: "ចាកចេញ",
